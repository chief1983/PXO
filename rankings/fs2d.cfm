...
<cfset maxscore=1000>
		...
		<font color="white"><b><div class="newsitemtitle">Welcome to the FreeSpace 2 Demo rankings page!</div></b></font>
...
<MAP NAME="charts">
<AREA SHAPE="RECT" COORDS="235,23,366,71" HREF="fs2d.cfm?type=scores">
<AREA SHAPE="RECT" COORDS="283,0,422,22" HREF="fs2d.cfm?type=kills">
<AREA SHAPE="RECT" COORDS="423,0,553,22" HREF="fs2d.cfm?type=msns">
<AREA SHAPE="RECT" COORDS="473,23,553,71" HREF="fs2d.cfm?type=time">
</MAP>
...
<table width="100%"><tr><td width="50%" align="left"><cfif this GT incrementer><a href="fs2d.cfm?<cfoutput>previous=#previous#&type=#type#</cfoutput>"><img src="../images/rankings/previous.gif" alt="" border="0" align="left"></a></cfif><br></td>
	<td width="50%" align="right"><cfif (stop LT maxscore) AND (stop LT fsscores.recordcount)><a href="fs2d.cfm?<cfoutput>next=#next#&type=#type#</cfoutput>"><img src="../images/rankings/next.gif" alt="" border="0" valign="right"></a></cfif><br></td></tr></table>
