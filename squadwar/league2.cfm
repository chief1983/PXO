				...
				<p>
					...
					<cfquery datasource="#currentdatasource#" name="rank_count">
						...
						<table width="90%" cellpadding=0 cellspacing=0 border=0>
							<tr><td align="center" colspan="9"><div class="title">The Top <cfoutput>#top_ranking_display#</cfoutput> of <cfoutput>#rank_count.recordcount#</cfoutput> Active Squadrons</div></td></tr>
							<tr>
