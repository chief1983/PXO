					...
					<img src="<cfoutput>#relativepath#</cfoutput>images/main/header.jpg" width=110 height=207 alt="" border="0"><br>
							...
							<table width="100%" cellpadding=0 cellspacing=0 border=0>
								<tr>
									...
									<td background="" valign="top">
										<div class="copy">
											<a href="<cfoutput>#relativepath#</cfoutput>new.cfm">New Pilots</a><br>
											<a href="<cfoutput>#relativepath#</cfoutput>login.cfm">Log In</a><br>
										</div>				
										&nbsp;<br>											
									</td>								
								</tr>
								...
								<tr>
									...
									<td background="" valign="top">
										<div class="copy">
											...
											<a href="<cfoutput>#relativepath#</cfoutput>faq/">FAQ</a><br>
											<a href="<cfoutput>#relativepath#</cfoutput>terms/">Terms</a><br>
