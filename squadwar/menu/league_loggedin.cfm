								...
								<tr>
									...
									<td background="" valign="top">
										<div class="copy">
											...
											<a href="enlist/">Enlist</a><br>
											<a href="recruits/">Recruit Board</a><br>	
											<a href="create/">Create a Squad</a><br>
											<a href="join/">Join a Squad</a><br>
											<a href="squads/admin.cfm">Admin Squad</a><br>
											<p>
											<font color="white"><b>League:</b></font><br>
											<cfif isdefined("leagueid")><cfif leagueid IS NOT ''>
											<a href="league.cfm?leagueid=<cfoutput>#leagueid#</cfoutput>">League Map</a>
											<a href="leaguehistory.cfm?leagueid=<cfoutput>#leagueid#</cfoutput>">League History</a>
											<a href="leaguepending.cfm?leagueid=<cfoutput>#leagueid#</cfoutput>">Pending Matches</a>
											</cfif></cfif>
										</div>				
										&nbsp;<br>											
									</td>								
								...
								<tr>
									...
									<td background="" valign="top">
										<div class="copy">
											...
											<a href="missions/">Mission List</a><br>											
									...
									<td background="" valign="top">
										...
										<div class="copy">
											<cfoutput query="get_swleagues">
												<a href="league.cfm?leagueid=#League_ID#">#Title#</a><br>
											</cfoutput>				
										</div>			
										&nbsp;<br>		
