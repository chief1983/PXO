									...
									<td background="" valign="top">
										<div class="copy">
											...
											<a href="<cfoutput>#relativepath#</cfoutput>enlist/">Enlist</a><br>
												&nbsp;&nbsp;<a href="<cfoutput>#relativepath#</cfoutput>enlist/enlist.cfm?action=add">Enlist/Edit Pilots</a><br>
												&nbsp;&nbsp;<a href="<cfoutput>#relativepath#</cfoutput>enlist/enlist.cfm?action=deactivate">Remove a Pilot</a><br>
