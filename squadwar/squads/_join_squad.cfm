...
<cfif (check_squad.recordcount IS 0)>
	<cflocation url="../error/error.cfm?message=This%20Squad%20no%20longer%20exists.">
<cfelseif (get_squad.recordcount IS 0)>
	<cflocation url="../error/error.cfm?message=Your%20Squad%20Join%20Password%20is%20incorrect.">	
<cfelseif (get_pxo.recordcount IS 0)>
	<cflocation url="../error/error.cfm?message=Your%20PXO%20login%20and%20password%20are%20incorrect.">
<cfelseif (get_squad_exists.recordcount IS 0)>
	<cflocation url="../error/error.cfm?message=The%20squad%20administrator%20has%20not%20set%20the%20join password.">

<cfelse>
<!---
<cfoutput>#check_squad.SquadMembers#<p>#get_pxo.trackerid#<p>#ListContainsNoCase("#check_squad.SquadMembers#", "#get_pxo.trackerid#")#<p></cfoutput>
--->
	<cfif ListContainsNoCase("#check_squad.SquadMembers#", "#get_pxo.trackerid#") is 0>
		This person is not on this squad.<br>
		...
		<cflocation url="squadinfo.cfm?id=#form.squadid#">
	<cfelse>
		<cflocation url="../error/error.cfm?message=This%20person%20is%20already%20a%20member%20of%20this%20squad.">	
	</cfif>
