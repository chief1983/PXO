...
<cfquery datasource='#currentdatasource#'>
	...
	SET
		<cfif (check_noshow.swsquad1 IS session.squadid)>swsquad1_protest = 1,swsquad1_protest_datetime = #Now()#</cfif>
		<cfif (check_noshow.swsquad2 IS session.squadid)>swsquad2_protest = 1,swsquad2_protest_datetime = #Now()#</cfif>
