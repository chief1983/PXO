	...
	<hr noshade color="#2E5537">				
	 	...
	 	<center>
	 		<table width="95%" cellpadding=0 cellspacing=0 border=0><tr><td>	
				...
				<div class="title"><cfoutput query="get_squad">#SquadName#</cfoutput> Squad Login</div>
			
			
						<div class="copy">
							<cfform action="squadlogin_validate.cfm?id=#id#" method="POST" enablecab="no" name="login">
