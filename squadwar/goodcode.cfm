...
<cfquery datasource="#currentdatasource#" name="challenge_test">
	...
	WHERE	SWSectors.SectorSquad = #current_team#
...
<select name="challenge_sector">
	<cfoutput query="final_challenge">
		<option value="#final_challenge.SWSectors_ID#">#final_challenge.SectorName#
	</cfoutput>
</select>
