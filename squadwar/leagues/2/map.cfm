...
<cfelse>
		...
		<table width=490 cellpadding=0 cellspacing=0 border=0>
			<tr>
				<td valign="top" rowspan=3><img src="<cfoutput>#relativepath#</cfoutput>images/leagues/2/left.gif" width=12 height=435 alt="" border="0"><br></td>
				<td valign="top"><img src="<cfoutput>#relativepath#</cfoutput>images/leagues/2/top.gif" width=450 height=28 alt="" border="0"><br></td>
				<td valign="top" rowspan=3><img src="<cfoutput>#relativepath#</cfoutput>images/leagues/2/right.gif" width=28 height=435 alt="" border="0" usemap="#fullscreen2"><br></td>
			</tr>
			<tr>
...
<!---					 <EMBED src="<cfoutput>#get_leagues.map_location#</cfoutput>?<cfoutput>#mapstring#</cfoutput>"  --->
			...
			<tr>
				<td valign="top"><img src="<cfoutput>#relativepath#</cfoutput>images/leagues/2/bottom.gif" width=450 height=69 alt="" border="0" usemap="#fullscreen"><br></td>
			</tr>
		</table>
		<!---
