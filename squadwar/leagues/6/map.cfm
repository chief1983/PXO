...
<cfelseif leagueid IS 2>
	<center>
		<cfset fullscreenhref='http://www.squadwar.com/leagues/2/map.cfm?isfullscreen=1&leagueid=#leagueid#'>
	</center>
<cfelseif leagueid IS 3>
	<center>
		<cfset fullscreenhref='http://www.squadwar.com/leagues/3/map.cfm?isfullscreen=1&leagueid=#leagueid#'>
	</center>
<cfelseif leagueid IS 4>
	<center>
		<cfset fullscreenhref='http://www.squadwar.com/leagues/4/map.cfm?isfullscreen=1&leagueid=#leagueid#'>
	</center>
<cfelseif leagueid IS 5>
	<center>
		<cfset fullscreenhref='http://www.squadwar.com/leagues/5/map.cfm?isfullscreen=1&leagueid=#leagueid#'>
	</center>	
<cfelseif leagueid IS 6>
	<center>
		<cfset fullscreenhref='http://www.squadwar.com/leagues/6/map.cfm?isfullscreen=1&leagueid=#leagueid#'>
	</center>	
</cfif>
...
<cfelse>
		...
		<table width=490 cellpadding=0 cellspacing=0 border=0>
			<tr>
				<td valign="top" rowspan=3><img src="<cfoutput>#relativepath#</cfoutput>images/leagues/3/left.gif" width=12 height=435 alt="" border="0"><br></td>
				<td valign="top"><img src="<cfoutput>#relativepath#</cfoutput>images/leagues/3/top.gif" width=450 height=28 alt="" border="0"><br></td>
				<td valign="top" rowspan=3><img src="<cfoutput>#relativepath#</cfoutput>images/leagues/3/right.gif" width=28 height=435 alt="" border="0" usemap="#fullscreen2"><br></td>
			</tr>
			<tr>
...
<!---					 <EMBED src="<cfoutput>#get_leagues.map_location#</cfoutput>?<cfoutput>#mapstring#</cfoutput>"  --->
			...
			<tr>
				<td valign="top"><img src="<cfoutput>#relativepath#</cfoutput>images/leagues/3/bottom.gif" width=450 height=69 alt="" border="0" usemap="#fullscreen"><br></td>
			</tr>
		</table>
		<!---
